...
import type { ResourceCategory } from "../backend";
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Sponsored partner offers — compare and apply
          </p>
        </div>
      </div>
      ...
      {!isLeadCaptured && (
        <div className="mb-4 flex items-center gap-3 bg-pastel-lavender/40 border border-pastel-lavender rounded-xl px-4 py-3">
          ...
          <p className="text-sm text-foreground/80">
            <strong>Unlock exclusive offers</strong> — fill in your details at
            the top of the page to reveal today's best loan rates.
          </p>
        </div>
      )}
