      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-white/65">
              Your trusted hub for US personal finance guidance. Empowering
              Americans to make smarter financial decisions.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-white/65 leading-relaxed">
              The information provided on US Finance Helps is for educational
              purposes only and does not constitute financial advice. Sponsored
              offers are partner content. Always consult a qualified financial
              professional.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-white/15 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/50">
          ...
          <span className="flex items-center gap-1">
            Built with{" "}
            <Heart className="w-3 h-3 text-pastel-rose fill-current" /> using{" "}
            <a
