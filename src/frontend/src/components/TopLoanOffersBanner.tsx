import { ExternalLink, Lock, Sparkles, Tag } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-base max-w-xl mx-auto">
            Compare today's best rates from trusted lenders. Pre-qualify in
            minutes with no impact to your credit score.
          </p>
        </div>
        ...
        {!isLeadCaptured ? (
          ...
          <div className="relative">
            ...
            <div
              className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 blur-sm pointer-events-none select-none opacity-70"
              aria-hidden="true"
            >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-white/30 backdrop-blur-[2px] rounded-xl">
              ...
              <div className="text-center max-w-sm px-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Enter your details in the form below to instantly reveal
                  today's best loan rates from our trusted partners.
                </p>
              </div>
            </div>
          </div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          Sponsored content. Rates shown are for illustrative purposes. Actual
          rates depend on creditworthiness and lender terms.
        </p>
      </div>
    </section>
  );
