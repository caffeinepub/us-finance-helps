...
const topics = [
  {
    ...
    label: "Budgeting",
    description:
      "Master your monthly spending, track expenses, and build a budget that actually works for your lifestyle.",
  ...
  },
  {
    ...
    label: "Saving",
    description:
      "Build your emergency fund, set savings goals, and discover high-yield accounts to grow your money faster.",
  ...
  },
  {
    ...
    label: "Investing",
    description:
      "Learn about stocks, ETFs, index funds, and strategies to grow your wealth over the long term.",
  ...
  },
  {
    ...
    label: "Taxes",
    description:
      "Navigate US tax laws, maximize deductions, and file confidently with expert guidance and tips.",
  ...
  },
  {
    ...
    label: "Credit",
    description:
      "Understand your credit score, improve your credit history, and use credit cards strategically.",
  ...
  },
  {
    ...
    label: "Loans",
    description:
      "Compare mortgage, auto, student, and personal loan options to make informed borrowing decisions.",
  ...
  },
  {
    ...
    label: "Retirement",
    description:
      "Plan for a secure retirement with 401(k), IRA, Social Security, and long-term investment strategies.",
...
export function HomePage() {
  ...
  const resourceCountByCategory = (resources ?? []).reduce<
      ...
      <section className="relative overflow-hidden bg-brand-deep">
        ...
        <div className="relative container mx-auto px-4 py-20 md:py-28 text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl max-w-2xl mx-auto mb-8 leading-relaxed">
            US Finance Helps provides clear, actionable guidance on budgeting,
            saving, investing, taxes, credit, loans, and more — all tailored for
            Americans.
          </p>
            ...
            <button
              ...
              onClick={() =>
                navigate({
                  ...
                  params: { category: ResourceCategory.loans },
                })
              }
      ...
      <section id="topics" className="container mx-auto px-4 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Explore our curated resources across all major personal finance
            categories.
          </p>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-base max-w-xl mx-auto">
              Real experiences from Americans who improved their finances with
              our guidance.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {highlightReviews.slice(0, 7).map(
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-0.5">
                        {Array.from({ length: review.rating }).map((_, i) => (
                          <Star
                            key={`star-${i + 1}`}
                            className="w-3.5 h-3.5 fill-pastel-gold text-pastel-gold"
                          />
                        ))}
                      </div>
                    </div>
        ...
        <section className="bg-secondary/30 py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-10">
              ...
              <p className="text-muted-foreground text-lg max-w-xl mx-auto">
                Hand-picked articles, guides, and tools to help you on your
                financial journey.
              </p>
            </div>
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {recentResources.map((resource, i) => (
                  <ResourceCard
                    key={resource.title || `resource-${i + 1}`}
                    resource={resource}
                  />
                ))}
              </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="bg-brand-deep rounded-2xl p-10 md:p-14 text-center text-white">
          ...
          <p className="text-white/75 text-lg max-w-xl mx-auto mb-8">
            Browse our comprehensive library of US personal finance resources
            and start making smarter money decisions today.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
