...
> = {
  ...
  [ResourceCategory.saving]: {
    label: "Saving",
    description:
      "Discover strategies to build your savings and create a financial safety net.",
  ...
  [ResourceCategory.investing]: {
    label: "Investing",
    description:
      "Grow your wealth through smart, long-term investment strategies.",
  ...
  [ResourceCategory.taxes]: {
    label: "Taxes",
    description:
      "Navigate the US tax system and maximize your deductions legally.",
  ...
  [ResourceCategory.credit]: {
    label: "Credit",
    description:
      "Build and maintain excellent credit to unlock better financial opportunities.",
    icon: <CreditCard className="w-8 h-8" />,
    tips: [
      "Pay bills on time — it's 35% of your score",
  ...
  [ResourceCategory.loans]: {
    label: "Loans",
    description:
      "Understand your borrowing options and make informed loan decisions.",
  ...
  [ResourceCategory.retirement]: {
    label: "Retirement",
    description:
      "Plan for a financially secure retirement with the right accounts and strategies.",
    icon: <Umbrella className="w-8 h-8" />,
    tips: [
      "Contribute enough to get your employer 401(k) match",
...
export function CategoryPage() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetResourcesByCategory(categoryEnum);
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            {/* Search */}
            <div>
              <h3 className="font-serif font-bold text-foreground text-xl mb-4">
                Resources
              </h3>
            ...
            <div className="bg-pastel-lavender/30 rounded-xl p-5 border border-pastel-lavender sticky top-24">
              ...
              {!isLeadCaptured && (
                <div className="mt-5 pt-4 border-t border-pastel-lavender">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Fill in your details to reveal today's best loan rates from
              ...
              <div className="mt-6 pt-5 border-t border-pastel-lavender">
                <p className="text-xs text-muted-foreground leading-relaxed">
                  ...
                  advice. Sponsored offers are partner content.
                </p>
              </div>
            </div>
          </aside>
